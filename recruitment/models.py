...
class SurveyTemplate(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager("company_id")
...
class Recruitment(EVOTEM HRModel):
    """
    Recruitment model
    """
...
class Stage(EVOTEM HRModel):
    ...
    objects = EVOTEM HRCompanyManager(related_company_field="recruitment_id__company_id")
...
class Candidate(EVOTEM HRModel):
    """
    Candidate model
    """
...
class RejectReason(EVOTEM HRModel):
    """
    RejectReason
    """
...
class RejectedCandidate(EVOTEM HRModel):
    """
    RejectedCandidate
    """
...
class StageFiles(EVOTEM HRModel):
...
class StageNote(EVOTEM HRModel):
    """
    StageNote model
    """
...
class RecruitmentSurvey(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(EVOTEM HRModel):
    """
...
class RecruitmentSurveyAnswer(EVOTEM HRModel):
    """
...
class SkillZone(EVOTEM HRModel):
    """ "
...
class SkillZoneCandidate(EVOTEM HRModel):
    """
...
class CandidateRating(EVOTEM HRModel):
...
class RecruitmentGeneralSetting(EVOTEM HRModel):
    """
...
class InterviewSchedule(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(EVOTEM HRModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(EVOTEM HRModel):
...
class LinkedInAccount(EVOTEM HRModel):
