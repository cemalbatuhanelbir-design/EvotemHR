...
class LinkedinSettingSectionView(views.EVOTEM HRSectionView):
    """
...
class LinkedInSettingNavView(views.EVOTEM HRNavView):
    """
...
class LinkedInAccountFormView(views.EVOTEM HRFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.EVOTEM HRListView):
    """
