...
from base.models import EVOTEM HRMailTemplate
...
class AutomationSectionView(views.EVOTEM HRSectionView):
    """
...
class AutomationNavView(views.EVOTEM HRNavView):
    """
    AutomationNavView
    """
...
class AutomationFormView(views.EVOTEM HRFormView):
    """
    AutomationFormView
    """
...
class AutomationListView(views.EVOTEM HRListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.EVOTEM HRDetailedView):
    """
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = EVOTEM HRMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = EVOTEM HRMailTemplate.objects.filter(
                body=template_body
            ).first()
