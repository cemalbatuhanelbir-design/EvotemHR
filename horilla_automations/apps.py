"""
App configuration for the EVOTEM HR Automations app.
...
class EVOTEM HRAutomationConfig(AppConfig):
    """Configuration class for the EVOTEM HR Automations Django app."""
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from base.templatetags.evotem_hrfilters import app_installed
