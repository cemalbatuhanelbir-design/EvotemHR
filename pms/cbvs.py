...
class BonusPointSettingSectionView(views.EVOTEM HRSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.EVOTEM HRNavView):
    """
...
class BonusPointSettingFormView(views.EVOTEM HRFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.EVOTEM HRListView):
    """
...
class EmployeeBonusPointSectionView(views.EVOTEM HRSectionView):
    """
...
class EmployeeBonusPointNavView(views.EVOTEM HRNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.EVOTEM HRFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.EVOTEM HRListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.EVOTEM HRFormView):
    """
...
class BulkFeedbackFormView(views.EVOTEM HRFormView):
    """
    Feedback other employee form View
    """
