...
from horilla.models import EVOTEM HRModel
...
class KeyResult(EVOTEM HRModel):
    ...
    history = EVOTEM HRAuditLog(bases=[EVOTEM HRAuditInfo])
...
class Objective(EVOTEM HRModel):
...
class EmployeeObjective(EVOTEM HRModel):
    ...
    history = EVOTEM HRAuditLog(bases=[EVOTEM HRAuditInfo], related_name="history_set")
    archive = models.BooleanField(default=False)
...
class Comment(models.Model):
    ...
    history = EVOTEM HRAuditLog(excluded_fields=["comment"], bases=[EVOTEM HRAuditInfo])
    objects = EVOTEM HRCompanyManager(
...
class QuestionTemplate(EVOTEM HRModel):
...
class Question(EVOTEM HRModel):
    ...
    objects = EVOTEM HRCompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(EVOTEM HRModel):
    ...
    objects = EVOTEM HRCompanyManager("question_id__template_id__company_id")


class Feedback(EVOTEM HRModel):
...
class EmployeeBonusPoint(EVOTEM HRModel):
    employee_id = models.ForeignKey(
        Employee,
        on_delete=models.DO_NOTHING,
