...
from base.forms import ModelForm as EVOTEM HRModelForm
...
from horilla_widgets.widgets.select_widgets import EVOTEM HRMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = EVOTEM HRMultiSelectField(
            queryset=Employee.objects.all(),
            widget=EVOTEM HRMultiSelectWidget(
        ...
        self.fields["managers"] = EVOTEM HRMultiSelectField(
            queryset=Employee.objects.all(),
            widget=EVOTEM HRMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class KRForm(EVOTEM HRModelForm):
    """
...
class FeedbackForm(EVOTEM HRModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # EVOTEM HR multi-select filter for subordinates
        # self.fields["subordinate_id"] = EVOTEM HRMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=EVOTEM HRMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class PeriodForm(EVOTEM HRModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("evotem_hr_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], EVOTEM HRMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = EVOTEM HRMultiSelectField(
...
class BonusPointSettingForm(EVOTEM HRModelForm):
    """
...
class EmployeeBonusPointForm(EVOTEM HRModelForm):
    """
...
class EmployeeFeedbackForm(EVOTEM HRModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = EVOTEM HRMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=EVOTEM HRMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], EVOTEM HRMultiSelectField):
...
class BulkFeedbackForm(EVOTEM HRModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = EVOTEM HRMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=EVOTEM HRMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], EVOTEM HRMultiSelectField):
