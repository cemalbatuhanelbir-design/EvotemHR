...
class LDAPSettings(models.Model):
    ...
    bind_dn = models.CharField(max_length=255, default="cn=admin,dc=evotem_hr,dc=com")
    bind_password = models.CharField(max_length=255)
    base_dn = models.CharField(max_length=255, default="ou=users,dc=evotem_hr,dc=com")
