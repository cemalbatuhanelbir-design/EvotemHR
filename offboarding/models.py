...
class Offboarding(EVOTEM HRModel):
    """
    Offboarding model
    """
...
class OffboardingStage(EVOTEM HRModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(EVOTEM HRModel):
    """
...
class OffboardingEmployee(EVOTEM HRModel):
    """
...
class ResignationLetter(EVOTEM HRModel):
    """
...
class OffboardingTask(EVOTEM HRModel):
    """
...
class EmployeeTask(EVOTEM HRModel):
    """
    EmployeeTask model
    """
...
class ExitReason(EVOTEM HRModel):
    """
    ExitReason model
    """
...
class OffboardingNote(EVOTEM HRModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(EVOTEM HRModel):
    """
