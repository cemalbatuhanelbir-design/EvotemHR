...
class LeaveType(EVOTEM HRModel):
...
class CompanyLeave(EVOTEM HRModel):
...
class AvailableLeave(EVOTEM HRModel):
...
class LeaveRequest(EVOTEM HRModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(EVOTEM HRModel):
    """
...
class LeaveAllocationRequest(EVOTEM HRModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(EVOTEM HRModel):
    """
...
class RestrictLeave(EVOTEM HRModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(EVOTEM HRModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(EVOTEM HRModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(EVOTEM HRModel):
        """
...
class EmployeePastLeaveRestrict(EVOTEM HRModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        #     """
        #     WorkRecords = get_evotem_hr_model_class(
