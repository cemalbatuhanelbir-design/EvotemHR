"""
This module provides EVOTEM HR ModelForms for creating and managing leave-related data,
...
from horilla_widgets.forms import EVOTEM HRForm, EVOTEM HRModelForm
...
class LeaveOneAssignForm(EVOTEM HRModelForm):
    """
    ...
    Attributes:
        - employee_id: A EVOTEM HRMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(EVOTEM HRForm):
    """
    Form for Payslip
    """
