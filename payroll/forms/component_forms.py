...
from horilla_widgets.forms import EVOTEM HRForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = EVOTEM HRMultiSelectField(
...
class GeneratePayslipForm(EVOTEM HRForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(evotem_hr_middlewares._thread_locals, "request", None)
    ...
    def setup_leave_fields(self):
        ...
        AvailableLeave = get_evotem_hr_model_class(
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_evotem_hr_model_class("leave", "availableleave")
