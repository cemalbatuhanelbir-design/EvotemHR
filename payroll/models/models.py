...
class FilingStatus(EVOTEM HRModel):
    """
    FilingStatus model
    """
...
class Allowance(EVOTEM HRModel):
    """
    Allowance model
    """
...
class Deduction(EVOTEM HRModel):
    """
    Deduction model
    """
...
class LoanAccount(EVOTEM HRModel):
    """
...
class Reimbursement(EVOTEM HRModel):
    """
    Reimbursement Model
    """
            ...
            if self.status == "approved" and self.allowance_id is None:
                if self.type == "reimbursement":
                    ...
                    if bonus_points.points >= self.bonus_to_encash:
                        ...
                        request = getattr(
                            evotem_hr_middlewares._thread_locals, "request", None
                        )
                        if request:
                            messages.info(
                                request,
...
class ReimbursementrequestComment(EVOTEM HRModel):
    """
