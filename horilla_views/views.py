...
from horilla_views.generic.cbv.views import EVOTEM HRFormView, EVOTEM HRListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.EVOTEM HRModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(EVOTEM HRFormView):
    """
    SavedFilter
    """
...
class DynamiListView(EVOTEM HRListView):
    """
...
class EVOTEM HRDeleteConfirmationView(View):
    """
