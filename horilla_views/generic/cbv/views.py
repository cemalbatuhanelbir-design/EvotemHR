...
class EVOTEM HRListView(ListView):
    """
    EVOTEM HRListView
    """
    ...
    template_name: str = "generic/evotem_hr_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return EVOTEM HRFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[EVOTEM HRListView] = context
    ...
    def export_data(self, *args, **kwargs):
        ...
        class EVOTEM HRListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = EVOTEM HRListViewResorce()
...
class EVOTEM HRSectionView(TemplateView):
    """
    EVOTEM HR Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, EVOTEM HRListView)
    ...
    template_name = "generic/evotem_hr_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/evotem_hr_detailed_view.html"
    header: dict = {
        "title": "EVOTEM HR",
        "subtitle": "EVOTEM HR Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, EVOTEM HRDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRTabView(TemplateView):
    """
    EVOTEM HRTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/evotem_hr_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, EVOTEM HRTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[EVOTEM HRTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRCardView(ListView):
    """
    EVOTEM HRCardView
    """
    ...
    template_name = "generic/evotem_hr_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, EVOTEM HRCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[EVOTEM HRCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRFormView(FormView):
    """
    EVOTEM HRFormView
    """
    ...
    template_name = "generic/evotem_hr_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, EVOTEM HRFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[EVOTEM HRFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRNavView(TemplateView):
    """
    EVOTEM HRNavView
    ...
    template_name = "generic/evotem_hr_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, EVOTEM HRNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[EVOTEM HRNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class EVOTEM HRProfileView(DetailView):
    """
    GenericEVOTEM HRProfileView
    """

    template_name = "generic/evotem_hr_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, EVOTEM HRProfileView)
