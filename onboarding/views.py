...
from base.models import EVOTEM HRMailTemplate, JobPosition
...
def candidates_view(request):
    ...
    mail_templates = EVOTEM HRMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        EVOTEM HRMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
