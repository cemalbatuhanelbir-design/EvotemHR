...
class OnboardingStage(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(EVOTEM HRModel):
    """
...
class CandidateTask(EVOTEM HRModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(EVOTEM HRModel):
    """
