"""
evotem_hr_api/urls/attendance/urls.py
"""

from django.urls import path

from evotem_hr_api.api_views.attendance.permission_views import AttendancePermissionCheck
from evotem_hr_api.api_views.attendance.views import *
