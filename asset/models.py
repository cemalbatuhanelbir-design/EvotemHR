...
class AssetCategory(EVOTEM HRModel):
    """
...
class Asset(EVOTEM HRModel):
    ...
    objects = EVOTEM HRCompanyManager("asset_category_id__company_id")
...
class AssetReport(EVOTEM HRModel):
    """
...
class AssetDocuments(EVOTEM HRModel):
    """
...
class ReturnImages(EVOTEM HRModel):
    """
...
class AssetAssignment(EVOTEM HRModel):
    """
    ...
    objects = EVOTEM HRCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(EVOTEM HRModel):
    """
