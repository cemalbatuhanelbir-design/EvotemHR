...
class DepartmentManager(EVOTEM HRModel):
    ...
    objects = EVOTEM HRCompanyManager("manager__employee_work_info__company_id")
...
class TicketType(EVOTEM HRModel):
...
class ClaimRequest(EVOTEM HRModel):
...
class Attachment(EVOTEM HRModel):
...
class FAQCategory(EVOTEM HRModel):
