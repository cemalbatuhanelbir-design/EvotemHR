...
from horilla.filters import FilterSet, EVOTEM HRFilterSet, filter_by_name

from .models import Employee, Project, Task, TimeSheet


class ProjectFilter(EVOTEM HRFilterSet):
...
class TaskAllFilter(EVOTEM HRFilterSet):
    search = django_filters.CharFilter(method="filter_by_task")
    end_till = django_filters.DateFilter(
        field_name="end_date",
        lookup_expr="lte",
...
class TimeSheetFilter(EVOTEM HRFilterSet):
    """
