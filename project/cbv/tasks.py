...
@method_decorator(login_required, name="dispatch")
class TaskListView(EVOTEM HRListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(EVOTEM HRNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(EVOTEM HRFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(EVOTEM HRDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(EVOTEM HRCardView):
    """
