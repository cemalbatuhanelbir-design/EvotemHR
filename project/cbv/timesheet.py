...
class TimeSheetNavView(EVOTEM HRNavView):
    """
    Nav bar
    """
...
class TimeSheetList(EVOTEM HRListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = EVOTEM HRListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(EVOTEM HRFormView):
    """
...
class TimeSheetCardView(EVOTEM HRCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(EVOTEM HRDetailedView):
    """
