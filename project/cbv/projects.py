...
class ProjectsNavView(EVOTEM HRNavView):
    """
    Nav bar
    """
...
class ProjectsList(EVOTEM HRListView):
    """
    Projects list view
    """
...
class ProjectFormView(EVOTEM HRFormView):
    """
...
class ProjectCardView(EVOTEM HRCardView):
    """
    For card view
    """
...
# Remove the command lines after evotem_hr converted into CBV
