...
from horilla_views.generic.cbv.views import EVOTEM HRDetailedView, EVOTEM HRListView
...
class ProjectsDueInMonth(EVOTEM HRListView):
...
class ProjectDetailView(EVOTEM HRDetailedView):
    """
