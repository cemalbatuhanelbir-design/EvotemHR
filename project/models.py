...
class ProjectStage(EVOTEM HRModel):
    """
    ProjectStage model
    """
    ...
    objects = EVOTEM HRCompanyManager("project__company_id")
...
class TimeSheet(EVOTEM HRModel):
    """
    TimeSheet model
    """
    ...
    objects = EVOTEM HRCompanyManager("project_id__company_id")
