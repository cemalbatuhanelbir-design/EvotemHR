...
from horilla.filters import EVOTEM HRPaginator
from horilla.group_by import group_by_queryset
from horilla.evotem_hr_settings import EVOTEM_HR_DATE_FORMATS
...
def paginator_qry(qryset, page_number):
    ...
    """
    paginator = EVOTEM HRPaginator(qryset, get_pagination())
        ...
        for models in related_models:
            ...
            if field_name:
                ...
                if (
                    ...
                    Recruitment = get_evotem_hr_model_class(
                    ...
                    Stage = get_evotem_hr_model_class(
                    ...
                    OnboardingStage = get_evotem_hr_model_class(
                    ...
                    OnboardingTask = get_evotem_hr_model_class(
    ...
    for employee in employees:
        for column_value, column_name in selected_columns:
            ...
            if isinstance(value, date):
                try:
                    data = value.strftime(
                        EVOTEM_HR_DATE_FORMATS.get(date_format, "%Y-%m-%d")
                    )
                except Exception:
                    data = str(value)
...
def joining_today_count(request):
    ...
    if apps.is_installed("recruitment"):
        Candidate = get_evotem_hr_model_class(app_label="recruitment", model="candidate")
...
def bonus_points_tab(request, emp_id):
    ...
    try:
        ...
        if apps.is_installed("payroll"):
            Reimbursement = get_evotem_hr_model_class(
