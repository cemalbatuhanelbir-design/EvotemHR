...
from horilla.methods import get_evotem_hr_model_class
from horilla.models import EVOTEM HRModel, has_xss, upload_path
...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_evotem_hr_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_evotem_hr_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_evotem_hr_model_class("recruitment", "recruitment")
            Stage = get_evotem_hr_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_evotem_hr_model_class("attendance", "attendance")
...
class EmployeeTag(EVOTEM HRModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(EVOTEM HRModel):
    """
...
class NoteFiles(EVOTEM HRModel):
...
class EmployeeNote(EVOTEM HRModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(EVOTEM HRModel):
    """
...
class BonusPoint(EVOTEM HRModel):
    """
...
class Actiontype(EVOTEM HRModel):
    """
    Action type model
    """
...
class DisciplinaryAction(EVOTEM HRModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(EVOTEM HRModel):
    """
...
class ProfileEditFeature(EVOTEM HRModel):
    """
    ProfileEditFeature
    """
