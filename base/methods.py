...
from horilla.evotem_hr_apps import NESTED_SUBORDINATE_VISIBILITY
from horilla.evotem_hr_middlewares import _thread_locals
from horilla.evotem_hr_settings import EVOTEM_HR_DATE_FORMATS, EVOTEM_HR_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in EVOTEM_HR_TIME_FORMATS.items():
        ...
        for format_name, format_string in EVOTEM_HR_DATE_FORMATS.items():
