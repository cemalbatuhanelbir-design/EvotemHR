...
from horilla.evotem_hr_apps import TWO_FACTORS_AUTHENTICATION
from horilla.evotem_hr_settings import APPS
from horilla.methods import get_evotem_hr_model_class
from horilla_documents.models import DocumentRequest

CACHE_KEY = "evotem_hr_company_models_cache_key"
...
class CompanyMiddleware:
    ...
    def _add_company_filter(self, model, company_id):
        ...
        is_evotem_hr_manager = isinstance(model.objects, EVOTEM HRCompanyManager)
        ...
        if is_company_model:
            ...
            elif is_evotem_hr_manager and related_company_field:
                model.add_to_class(
            ...
            for app_label, models in app_model_mappings.items():
                if apps.is_installed(app_label):
                    company_models.extend(
                        [get_evotem_hr_model_class(app_label, model) for model in models]
                    )
