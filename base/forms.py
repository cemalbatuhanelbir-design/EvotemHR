...
class AssignPermission(Form):
    ...
    employee = EVOTEM HRMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = EVOTEM HRMultiSelectField(
...
class RotatingWorkTypeAssignForm(ModelForm):
    ...
    employee_id = EVOTEM HRMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = EVOTEM HRMultiSelectField(
        queryset=Employee.objects.all(),
        widget=EVOTEM HRMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], EVOTEM HRMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_evotem_hr_model_class(app_label="leave", model="leavetype")
