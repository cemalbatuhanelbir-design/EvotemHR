...
from horilla.evotem_hr_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_evotem_hr_model_class(app_label, model):
    """
...
def evotem_hr_users_with_perms(permissions):
    """
