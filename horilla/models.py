...
This module defines the abstract base model `EVOTEM HRModel` for the EVOTEM HR HRMS project.
The `EVOTEM HRModel` provides common fields and functionalities for other models within
...
class EVOTEM HRModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the EVOTEM HR application.
    """
    ...
    evotem_hr_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(EVOTEM HRModel, self).save(*args, **kwargs)
...
auditlog.register(EVOTEM HRModel, serialize_data=True)
