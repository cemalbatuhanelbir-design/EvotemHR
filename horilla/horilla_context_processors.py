"""
evotem_hr_context_process.py

This module is used to register context processors without effecting the evotem_hr/settings.py module
"""

from horilla.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "evotem_hr.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
