...
from horilla.evotem_hr_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=evotem_hr,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="evotem_hr"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=evotem_hr,dc=com"),
}
