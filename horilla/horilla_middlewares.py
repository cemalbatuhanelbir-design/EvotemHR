"""
evotem_hr_middlewares.py

This module is used to register evotem_hr's middlewares without affecting the evotem_hr/settings.py
"""
...
MIDDLEWARE.append("evotem_hr.evotem_hr_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("evotem_hr.evotem_hr_middlewares.ThreadLocalMiddleware")
MIDDLEWARE.append("evotem_hr.evotem_hr_middlewares.SVGSecurityMiddleware")
