...
class AttendanceActivity(EVOTEM HRModel):
    """
...
class BatchAttendance(EVOTEM HRModel):
    """
...
class Attendance(EVOTEM HRModel):
    """
    Attendance model
    """
...
class AttendanceRequestFile(EVOTEM HRModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(EVOTEM HRModel):
    """
...
class AttendanceOverTime(EVOTEM HRModel):
    """
...
class AttendanceLateComeEarlyOut(EVOTEM HRModel):
    """
...
class AttendanceValidationCondition(EVOTEM HRModel):
    """
...
class GraceTime(EVOTEM HRModel):
    """
...
class AttendanceGeneralSetting(EVOTEM HRModel):
    """
