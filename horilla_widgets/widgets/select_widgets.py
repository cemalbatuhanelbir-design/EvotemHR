...
This module is used to write evotem_hr form select widgets
"""
...
class EVOTEM HRMultiSelectWidget(forms.Widget):
    """
    EVOTEM HRMultiSelectWidget
    """
    ...
    template_name = "horilla_widgets/evotem_hr_multiselect_widget.html"
